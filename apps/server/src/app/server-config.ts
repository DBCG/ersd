...
export interface IServerConfig {
  ...
  payload: {
    ...
    ERSD_RELEASE_CANDIDATE_KEY_MD_KEY: string;
    ERSDV1_DRAFT_CANDIDATE_JSON_KEY: string;
    ERSDV1_DRAFT_CANDIDATE_XML_KEY:string;
    ERSDV2_DRAFT_CANDIDATE_JSON_KEY: string;
    ERSDV2_DRAFT_CANDIDATE_XML_KEY:string;
  };
}
